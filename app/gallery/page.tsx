...
export const metadata: Metadata = {
  ...
  description: 'A lifetime, in frames. Explore a curated collection of Frederick and Veronica’s portraits, save your favourites and watch the full-screen slideshow.',
