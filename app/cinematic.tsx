...
import {Frame,Photo,photos,Guestbook} from './wedding';
...
export function Home(){
 useEffect(()=>{if(window.location.hash==='#gallery')window.location.replace('/gallery')},[]);
 ...
 return <Frame page="home">
  ...
  <section className="home-reply" id="rsvp" aria-label="RSVP"><div className="section-kicker"><span>04 / YOUR INVITATION</span><span>THE PLEASURE OF YOUR COMPANY</span></div><RSVP embedded/></section>
  <div className="home-guest-info" id="guest-info"><GuestGuide embedded/></div>
  <section className="home-guestbook" id="guestbook" aria-label="Guestbook"><div className="section-kicker"><span>05 / THE GUESTBOOK</span><span>WORDS WE’LL KEEP FOREVER</span></div><Guestbook embedded/></section>
 </Frame>
}
